 ...
 * [./test/assets/given/analogger/analogger-test.cjs]{@link ./test/assets/given/analogger/analogger-test.cjs}
 * 
 **/
import toAnsi  from "to-ansi";
import {COLOR_TABLE, SYSTEM}  from "./test/assets/given/analogger/constants.mjs";
