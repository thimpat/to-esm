const DATA_EXCHANGE_INFO = require("./data-exchanger.cjs");

const {DIRECTION, MESSAGE_TYPE, SYSTEM_TYPE} = require("./specificities.cjs");
...
module.exports = CommonFeatureExchanger;