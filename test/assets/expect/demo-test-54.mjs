 ...
 * @see [./assets/given/demo-test-54.cjs]{@link ./assets/given/demo-test-54.cjs}
 * 
 **/
import { fileURLToPath } from "url";
import { dirname } from "path";
const __dirname = dirname(fileURLToPath(import.meta.url));
import {constants, existsSync, mkdirSync, readFileSync, lstatSync, createWriteStream, createReadStream}  from "fs";
